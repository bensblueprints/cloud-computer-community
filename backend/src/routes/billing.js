...
const PLANS = {
  ...
  TEAM: { seats: 5, priceId: process.env.STRIPE_PRICE_TEAM, price: 79, templateVmid: parseInt(process.env.PROXMOX_TEMPLATE_TEAM) || 514 },
  ARMY: { seats: 25, priceId: process.env.STRIPE_PRICE_ARMY, price: 299, templateVmid: parseInt(process.env.PROXMOX_TEMPLATE_ARMY) || 515 }
};
